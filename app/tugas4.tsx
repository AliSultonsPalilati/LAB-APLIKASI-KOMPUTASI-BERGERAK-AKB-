...
export default function Tugas4() {
  ...
  // Ini menghilangkan peringatan 'exhaustive-deps' karena tidak ada dependensi luar.
  useEffect(() => {
    ...
    setData({ sebelum, setelah, target: daftarMhs[idx] });
  }, []); // <-- Dependency array kosong sekarang sudah benar dan tidak akan memicu peringatan.
